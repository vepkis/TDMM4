package processing.test.xenofobia_04;
...
public class Xenofobia_04 extends PApplet {
...
class Frontera
{
  ...
  /*float o, p, q, r;
   ...
   float ancho, disty, distyApertura, umbralIngreso, umbralRechazo;
...
class Mundo
{
  ...
  public void reinicioGeneral()
  {
    ...
    for (int i=0; i< bb22.length; i++ )
    {
      if (getCondicionColorCompleja()[i]== false && bb22[i].getLugar()==true ) {
        bb22[i].reinicio();
      }
      cambiaComp[i]=false;
    }
