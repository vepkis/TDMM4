class Esferas {
  ...
  Esferas() { 
    ...
    esf[0]= new Esfera (40, int (random(width/2-width/3, width/2+width/3)), int (random(65, height/3)), zona1);
    ...
    esf[10]= new Esfera (55 , int (random(tam, width/2-tam*2)), int (random(height/2, height-tam)), zona2);
    esf[11]= new Esfera ( 55, int (random(tam, width/2-tam*2)), int (random(height/2, height-tam)), zona2);
    esf[12]= new Esfera ( 55, int (random(tam, width/2-tam*2)), int (random(height/2, height-tam)), zona2);
    esf[13]= new Esfera ( 55, int (random(tam, width/2-tam*2)), int (random(height/2, height-tam)), zona2);
    esf[14]= new Esfera ( 55, int (random(tam, width/2-tam*2)), int (random(height/2, height-tam)), zona2);
    esf[15]= new Esfera ( 55, int (random(tam, width/2-tam*2)), int (random(height/2, height-tam)), zona2);
    esf[16]= new Esfera ( 55, int (random(tam, width/2-tam*2)), int (random(height/2, height-tam)), zona2);




    esf[17] = new Esfera(45, int (random(width/2 +tam*2, width-tam)), int (random(height/2 +tam, height-tam)), zona3); 
    esf[18] = new Esfera(45, int (random(width/2 +tam*2, width-tam)), int (random(height/2 +tam, height-tam)), zona3);    
    esf[19] = new Esfera(45, int (random(width/2 +tam*2, width-tam)), int (random(height/2 +tam, height-tam)), zona3); 
    esf[20] = new Esfera(45, int (random(width/2 +tam*2, width-tam)), int (random(height/2 +tam, height-tam)), zona3); 
    esf[21] = new Esfera(45, int (random(width/2 +tam*2, width-tam)), int (random(height/2 +tam, height-tam)), zona3); 
    esf[22] = new Esfera(45, int (random(width/2 +tam*2, width-tam)), int (random(height/2 +tam, height-tam)), zona3);    
    esf[23] = new Esfera(45, int (random(width/2 +tam*2, width-tam)), int (random(height/2 +tam, height-tam)), zona3);
  }
