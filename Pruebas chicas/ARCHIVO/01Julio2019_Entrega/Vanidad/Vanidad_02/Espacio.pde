class Espacio
{
  ...
  Espacio(float zrPosX_, float zrPosY_, float zrTamAncho_, float zrTamAlto_, float zpPosX_, float zpPosY_, float zpTamAncho_, float zpTamAlto_, color zReflejo_, color zPelotita_)
